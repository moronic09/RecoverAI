...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex bg-paper text-ink">
      <aside className="w-64 border-r border-paper-line bg-paper flex flex-col">
        <div className="p-6 border-b border-paper-line">
        ...
        <nav className="flex-1 p-4 space-y-1">
          {navItems.map(({ to, icon: Icon, label }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  'flex items-center gap-3 px-3 py-2.5 border-b text-sm font-medium transition-colors',
                  isActive
